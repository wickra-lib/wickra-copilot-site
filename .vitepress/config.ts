...
const structuredData = {
  ...
  '@graph': [
    {
      '@type': 'Organization',
      '@id': 'https://copilot.wickra.org/#organization',
      name: 'Wickra',
      url: 'https://copilot.wickra.org/',
      logo: 'https://copilot.wickra.org/wickra-mark.svg',
      sameAs: [
        'https://github.com/wickra-lib/wickra-copilot',
    ...
    },
    {
      ...
      '@id': 'https://copilot.wickra.org/#software',
      name: 'Wickra Copilot',
      url: 'https://copilot.wickra.org/',
      ...
      description:
        'A local market copilot grounded in real order-book, liquidation and funding microstructure, in ten languages. Built on the Wickra core.',
      license: 'https://github.com/wickra-lib/wickra-copilot#license',
      publisher: { '@id': 'https://copilot.wickra.org/#organization' },
    },
  ],
}

export default defineConfig({
  title: 'Wickra Copilot',
  description:
    'A local market copilot grounded in real order-book, liquidation and funding microstructure, in ten languages. Built on the Wickra core.',
  lang: 'en-US',
  cleanUrls: true,

  // Served at the domain root (copilot.wickra.org via Cloudflare Pages).
  base: '/',

  sitemap: { hostname: 'https://copilot.wickra.org' },
  ...
  head: [
    ...
    ['meta', { property: 'og:title', content: 'Wickra Copilot — a local market copilot' }],
    [
      'meta',
      {
        property: 'og:description',
        content:
          'A local market copilot grounded in real order-book, liquidation and funding microstructure — LLM-agnostic, offline-first, in ten languages, deterministic and byte-identical across every binding.',
      },
    ],
    ['meta', { property: 'og:image', content: 'https://copilot.wickra.org/og-banner.webp' }],
    ['meta', { name: 'twitter:card', content: 'summary_large_image' }],
    ['meta', { name: 'twitter:image', content: 'https://copilot.wickra.org/og-banner.webp' }],
    ['script', { type: 'application/ld+json' }, JSON.stringify(structuredData)],
  ],

  transformPageData(pageData) {
    const path = pageData.relativePath.replace(/(?:index)?\.md$/, '')
    const canonical = `https://copilot.wickra.org/${path}`
  ...
  themeConfig: {
    siteTitle: 'Wickra Copilot',
    logo: { src: '/wickra-mark.svg', alt: 'Wickra Copilot' },
    ...
    nav: [
      ...
      { text: 'GitHub', link: 'https://github.com/wickra-lib/wickra-copilot' },
      {
        text: 'Links',
        items: [
      ...
      },
      {
        text: 'v0.1.0',
        items: [
          { text: 'Release notes', link: 'https://github.com/wickra-lib/wickra-copilot/releases' },
          { text: 'Changelog', link: 'https://github.com/wickra-lib/wickra-copilot/blob/main/CHANGELOG.md' },
          { text: 'docs.rs', link: 'https://docs.rs/wickra-copilot/latest/wickra_copilot/' },
        ],
      },
      {
        text: 'Ecosystem',
    ...
    socialLinks: [{ icon: 'github', link: 'https://github.com/wickra-lib/wickra-copilot' }],
