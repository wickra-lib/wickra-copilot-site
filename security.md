...
- GitHub → the [wickra-copilot repository](https://github.com/wickra-lib/wickra-copilot)
...
Wickra Copilot parses untrusted `ContextSpec` JSON and feed data, so its parser and
...
[SECURITY.md](https://github.com/wickra-lib/wickra-copilot/blob/main/SECURITY.md)
