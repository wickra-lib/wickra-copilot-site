<p align="center">
  <a href="https://copilot.wickra.org"><img src="https://raw.githubusercontent.com/wickra-lib/.github/main/profile/wickra-banner.webp?v=514" alt="Wickra Copilot — a local market copilot grounded in real order-book, liquidation and funding microstructure — LLM-agnostic, offline-first" width="100%"></a>
</p>
...
Source for the Wickra Copilot site (**[copilot.wickra.org](https://copilot.wickra.org)**): hero, per-language API overviews, benchmarks and the in-browser indicator demo.
...
**Wickra Copilot** — a local market copilot grounded in real order-book, liquidation and funding microstructure — LLM-agnostic, offline-first. The library itself is
[`wickra-lib/wickra-copilot`](https://github.com/wickra-lib/wickra-copilot); its README carries the install line and a quick start for every language.
...
- **The released version** — the version menu in the nav, the Maven snippet on the landing page and the Java API page — is pulled hourly from [wickra-copilot's latest release](https://github.com/wickra-lib/wickra-copilot/releases/latest) by `sync-from-copilot.yml`.
...
Custom domain `copilot.wickra.org` is configured in the Cloudflare Pages dashboard.
